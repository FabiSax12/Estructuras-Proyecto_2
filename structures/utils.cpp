...
void hideCursor(){
    ...
    GetConsoleCursorInfo(consoleHandle, &cursorInfo); // Obtener la información actual del cursor
    cursorInfo.bVisible = false;                      // Hacer el cursor invisible
    SetConsoleCursorInfo(consoleHandle, &cursorInfo); // Aplicar los cambios
}
...
void showCursor(){
    ...
    GetConsoleCursorInfo(consoleHandle, &cursorInfo); // Obtener la información actual del cursor
    cursorInfo.bVisible = true;                       // Hacer el cursor visible
    SetConsoleCursorInfo(consoleHandle, &cursorInfo); // Aplicar los cambios
}